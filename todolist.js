...
console.log(' ')
console.log('最近好像經常一早就惹怒學姊，但我不是真的沒有想讓你不開心')
console.log('也許這禮拜開始聊天驟減，我知道你有很多事情要處理，不管是公事還是私事，所以最近都會很忙，可能也會沒時間回我')
console.log('沒關係，你知道我一直都會在的，如果真的有什麼不開心的事情都可以告訴我，雖然我可能不能幫到什麼忙')
console.log('或是真的不開心我做什麼事情還是有什麼想法，其實你都可以直接告訴我')
console.log('我認真地希望我們都可以一起好好的，希望以後每次的見面你都會是輕鬆的開心的(´･∀･`)')
